...
import { DevelopmentFinanceCalculator } from "@/components/calculators/development-finance-calculator";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
const calc = getCalculatorBySlug("development-finance")!;

export const metadata: Metadata = {
  title: calc.metaTitle,
  description: calc.metaDescription,
  alternates: {
    canonical: `${SITE_URL}/calculators/development-finance`,
  },
  openGraph: {
    title: calc.metaTitle,
    description: calc.metaDescription,
    url: `${SITE_URL}/calculators/development-finance`,
    type: "website",
  },
};

export default function DevelopmentFinanceCalculatorPage() {
  const financialServiceJsonLd = {
    ...
    serviceType: "Development Finance",
    areaServed: { "@type": "Country", name: "United Kingdom" },
  };
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <nav className="mb-8 flex items-center gap-2 text-sm text-white/40">
            ...
            <span>/</span>
            <span className="text-white/70">Development Finance</span>
          </nav>
      ...
      <section className="bg-background py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <Link
              href="/calculators/mezzanine-finance"
              className="group rounded-xl border border-border bg-card p-6 transition-all duration-300 hover:border-gold/20 hover:shadow-md"
            >
              <h3 className="text-lg font-bold text-foreground group-hover:text-gold-dark transition-colors">
                Mezzanine Finance Calculator
              </h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Model mezzanine funding, blended cost and equity requirements.
              </p>
            </Link>
          </div>
        </div>
