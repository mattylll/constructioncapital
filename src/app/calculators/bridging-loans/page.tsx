...
const calc = getCalculatorBySlug("bridging-loans")!;

export const metadata: Metadata = {
  title: calc.metaTitle,
  description: calc.metaDescription,
  alternates: {
    canonical: `${SITE_URL}/calculators/bridging-loans`,
  },
  openGraph: {
    title: calc.metaTitle,
    description: calc.metaDescription,
    url: `${SITE_URL}/calculators/bridging-loans`,
    type: "website",
  },
};
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <nav className="mb-8 flex items-center gap-2 text-sm text-white/40">
            ...
            <span>/</span>
            <span className="text-white/70">Bridging Loans</span>
          </nav>
