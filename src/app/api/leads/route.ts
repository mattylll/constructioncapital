            ...
            <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a2e;">
              ...
              <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e5e5; border-top: none;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
                  <tr><td style="padding: 8px 0; color: #666; font-size: 14px; width: 140px;">Name</td><td style="padding: 8px 0; font-size: 14px; font-weight: 600;">${full_name}</td></tr>
                ...
                ${additional_info ? `<h2 style="font-size: 16px; color: #1a1a2e; margin: 0 0 16px; text-transform: uppercase; letter-spacing: 0.05em; border-bottom: 2px solid #c9a84c; padding-bottom: 8px;">Additional Information</h2><p style="font-size: 14px; line-height: 1.6; color: #333; margin: 0 0 24px; padding: 16px; background: #f8f8fa; border-radius: 8px;">${additional_info}</p>` : ""}
