...
export const content: CalculatorContent = {
  howItWorks: {
    title: "How chain break bridging works",
    paragraphs: [
  ...
  guide: {
    title: "Chain break bridging: saving your purchase when a chain collapses",
    sections: [
      {
        heading: "When chains collapse and how bridging fixes it",
        paragraphs: [
      ...
      {
        heading: "The cost of bridging vs the risk of losing the purchase",
        paragraphs: [
      ...
      {
        heading: "Regulated bridging for your own home: FCA rules and what they mean for you",
        paragraphs: [
      ...
      {
        heading: "How long chains take to resolve and exit strategy planning",
        paragraphs: [
