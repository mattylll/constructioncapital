...
export const content: CalculatorContent = {
  howItWorks: {
    title: "How refurbishment finance is structured",
    paragraphs: [
  ...
  guide: {
    title: "Refurbishment finance: light vs heavy and how lenders structure the deal",
    sections: [
      {
        heading: "Light refurbishment finance: cosmetic works up to 70% LTV",
        paragraphs: [
      ...
      {
        heading: "Heavy refurbishment finance: structural works, staged drawdowns, and GDV lending",
        paragraphs: [
      ...
      {
        heading: "Quantity surveyor inspections and the drawdown process",
        paragraphs: [
      ...
      {
        heading: "Exiting refurbishment finance: bridging to term and the refinance process",
        paragraphs: [
