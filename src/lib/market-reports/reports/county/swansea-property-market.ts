...
const report: MarketReport = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Property Type</th><th>Swansea Median</th><th>UK Median</th><th>Difference</th></tr></thead><tbody><tr><td><strong>Detached</strong></td><td>£340,000</td><td>£420,000</td><td>-£80k</td></tr><tr><td><strong>Semi-detached</strong></td><td>£202,000</td><td>£265,000</td><td>-£63k</td></tr><tr><td><strong>Terraced</strong></td><td>£155,000</td><td>£230,000</td><td>-£75k</td></tr><tr><td><strong>Flat</strong></td><td>£125,001</td><td>£225,000</td><td>-£100k</td></tr></tbody></table>`,
        `Detached homes command the highest prices at <strong>£340,000</strong>, while flat properties offer the most accessible entry point at <strong>£125,001</strong>. This £215k spread suggests opportunities for developers converting or building across the type spectrum.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        `New-build properties accounted for <strong>211</strong> of 13,511 total transactions (<strong>1.6%</strong>) across Swansea in the past 12 months. This indicates an active development pipeline with sustained buyer demand for new homes.`,
        `New-build properties in Swansea traded at an average <strong>premium of 74.1%</strong> compared to existing stock. This premium supports development viability, as end values comfortably exceed second-hand comparables.`,
        `The most active new-build markets are <a href="/locations/swansea/morriston">Morriston</a> (39 completions), <a href="/locations/swansea/mumbles">Mumbles</a> (39 completions), <a href="/locations/swansea/sa1-waterfront">SA1 Waterfront</a> (39 completions).`,
      ],
    },
    {
      heading: `Swansea Property Transaction Activity`,
      content: [
        `Swansea recorded <strong>13,511</strong> residential sales over the past 12 months, representing an estimated <strong>£2661.67m</strong> in total transacted value. This is a deep, liquid market where developers can have confidence in their exit strategy.`,
  ...
  faqs: [
    {
      ...
      answer: `The median house price across Swansea's principal towns is £197,000, based on 13,511 transactions recorded over the past 12 months. Detached homes average £340,000 while flat properties average £125,001.`,
    },
    {
    ...
    },
    {
      ...
      answer: `The most expensive towns in Swansea are Morriston (£197,000), Mumbles (£197,000), SA1 Waterfront (£197,000). The most affordable include Neath (£160,000), Swansea City Centre (£197,000), Sketty (£197,000).`,
    },
    {
      question: `How is the Swansea property market performing in 2026?`,
      answer: `Swansea property prices are rising at +4.2% year-on-year. The strongest performers are Neath (+6.7%) and Morriston (+3.7%). Transaction volumes of 13,511 sales indicate robust market activity.`,
    },
  ],
  ...
  charts: {"priceByType":[{"name":"Detached","value":340000},{"name":"Semi-detached","value":202000},{"name":"Terraced","value":155000},{"name":"Flat","value":125001}],"townPrices":[{"name":"Morriston","value":197000},{"name":"Mumbles","value":197000},{"name":"SA1 Waterfront","value":197000},{"name":"Sketty","value":197000},{"name":"Swansea City Centre","value":197000},{"name":"Neath","value":160000}],"townYoyChange":[{"name":"Neath","value":6.7},{"name":"Morriston","value":3.7},{"name":"Mumbles","value":3.7},{"name":"SA1 Waterfront","value":3.7},{"name":"Sketty","value":3.7},{"name":"Swansea City Centre","value":3.7}]},
};
