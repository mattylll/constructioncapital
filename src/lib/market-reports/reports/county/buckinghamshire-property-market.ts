...
const report: MarketReport = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Property Type</th><th>Buckinghamshire Median</th><th>UK Median</th><th>Difference</th></tr></thead><tbody><tr><td><strong>Detached</strong></td><td>£781,250</td><td>£420,000</td><td>+£361k</td></tr><tr><td><strong>Semi-detached</strong></td><td>£475,000</td><td>£265,000</td><td>+£210k</td></tr><tr><td><strong>Terraced</strong></td><td>£402,500</td><td>£230,000</td><td>+£173k</td></tr><tr><td><strong>Flat</strong></td><td>£243,750</td><td>£225,000</td><td>+£19k</td></tr></tbody></table>`,
        `Detached homes command the highest prices at <strong>£781,250</strong>, while flat properties offer the most accessible entry point at <strong>£243,750</strong>. This £538k spread suggests opportunities for developers converting or building across the type spectrum.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        `New-build properties accounted for <strong>191</strong> of 4,087 total transactions (<strong>4.7%</strong>) across Buckinghamshire in the past 12 months. This indicates an active development pipeline with sustained buyer demand for new homes.`,
        `New-build properties in Buckinghamshire traded at an average <strong>discount of 24.5%</strong> compared to existing stock. This discount suggests that developers may need to focus on design quality, specification, and location to achieve values above existing stock.`,
        `The most active new-build markets are <a href="/locations/buckinghamshire/aylesbury">Aylesbury</a> (152 completions), <a href="/locations/buckinghamshire/high-wycombe">High Wycombe</a> (24 completions), <a href="/locations/buckinghamshire/beaconsfield">Beaconsfield</a> (6 completions).`,
      ],
    },
    {
      heading: `Buckinghamshire Property Transaction Activity`,
      content: [
        `Buckinghamshire recorded <strong>4,087</strong> residential sales over the past 12 months, representing an estimated <strong>£1920.89m</strong> in total transacted value. This represents a moderately active market with reasonable exit confidence.`,
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£7.94m</td><td>O</td><td>HP13 5FX</td><td>2026-02-19</td><td>Existing</td></tr><tr><td>£2.73m</td><td>Detached</td><td>HP9 2NR</td><td>2026-01-30</td><td>Existing</td></tr><tr><td>£1.35m</td><td>Detached</td><td>SL7 2DD</td><td>2026-02-11</td><td>Existing</td></tr><tr><td>£1.26m</td><td>Detached</td><td>SL7 3NA</td><td>2026-01-19</td><td>Existing</td></tr><tr><td>£1.15m</td><td>Detached</td><td>HP5 1GE</td><td>2026-01-30</td><td>Existing</td></tr></tbody></table>`,
  ...
  faqs: [
    {
      ...
      answer: `The median house price across Buckinghamshire's principal towns is £470,000, based on 4,087 transactions recorded over the past 12 months. Detached homes average £781,250 while flat properties average £243,750.`,
    },
    {
    ...
    },
    {
      ...
      answer: `The most expensive towns in Buckinghamshire are Beaconsfield (£951,000), Amersham (£735,000), Marlow (£610,000). The most affordable include Aylesbury (£370,000), Buckingham (£378,000), High Wycombe (£420,000).`,
    },
    {
      question: `How is the Buckinghamshire property market performing in 2026?`,
      answer: `Buckinghamshire property prices are falling at -1.4% year-on-year. The strongest performers are Amersham (+4.3%) and Princes Risborough (+4.2%). Transaction volumes of 4,087 sales indicate healthy market activity.`,
    },
  ],
  relatedReportSlugs: ["london-and-south-east-market-overview", "berkshire-property-market", "essex-property-market", "greater-london-property-market"],
  ...
  charts: {"priceByType":[{"name":"Detached","value":781250},{"name":"Semi-detached","value":475000},{"name":"Terraced","value":402500},{"name":"Flat","value":243750}],"townPrices":[{"name":"Beaconsfield","value":951000},{"name":"Amersham","value":735000},{"name":"Marlow","value":610000},{"name":"Princes Risborough","value":500000},{"name":"Chesham","value":440000},{"name":"High Wycombe","value":420000},{"name":"Buckingham","value":378000},{"name":"Aylesbury","value":370000}],"townYoyChange":[{"name":"Amersham","value":4.3},{"name":"Princes Risborough","value":4.2},{"name":"High Wycombe","value":0},{"name":"Chesham","value":-1.7},{"name":"Aylesbury","value":-2.4},{"name":"Buckingham","value":-3.1},{"name":"Beaconsfield","value":-3.2},{"name":"Marlow","value":-9.6}]},
};
