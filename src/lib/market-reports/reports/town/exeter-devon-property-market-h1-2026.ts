...
const report: MarketReport = {
  ...
  metaTitle: "Exeter House Prices 2026: £300,000 Median",
  metaDescription: "Exeter house prices 2026: £300,000 median, 1,265 sales, 0% YoY. Sold-price trends by property type, new-build premiums and development finance.",
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Exeter`,
      content: [
        `Exeter City Council — the local planning authority covering Exeter — has <strong>529</strong> residential units in its current pipeline, an estimated gross development value of <strong>£158.6m</strong>, across 92 applications (17 approved, 75 pending) at an approval rate of <strong>94%</strong>.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£265,000</td><td>Terraced</td><td>EX2 7TD</td><td>2026-05-27</td><td>Existing</td></tr><tr><td>£220,000</td><td>Semi-detached</td><td>EX2 5LQ</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£295,000</td><td>Semi-detached</td><td>EX3 0NA</td><td>2026-05-18</td><td>Existing</td></tr><tr><td>£477,500</td><td>Semi-detached</td><td>EX2 4SD</td><td>2026-05-15</td><td>Existing</td></tr><tr><td>£130,000</td><td>Semi-detached</td><td>EX4 1PL</td><td>2026-05-14</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £130,000 to £477,500 illustrates the breadth of the Exeter market.`,
      ],
    },
    {
      heading: `Development Finance in Exeter`,
      content: [
        `For developers considering Exeter, the local market data translates directly into finance structuring. With a median value of £300,000 and detached homes at £450,000, lenders can assess scheme viability with confidence.`,
        ...
        `While prices have remained flat year-on-year, experienced developers can still generate strong returns in Exeter by targeting well-located sites with clear demand drivers.`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `House prices in Exeter are flat at 0% year-on-year. The market is broadly stable. The wider Devon market is falling at -2.5%.`,
    },
    {
