...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Bootle`,
      content: [
        `Sefton Council — the local planning authority covering Bootle — has <strong>93</strong> residential units in its current pipeline, an estimated gross development value of <strong>£11.8m</strong>, across 5 applications (0 approved, 5 pending) at an approval rate of <strong>0%</strong>.`,
        `Sefton Council covers more than one town in Merseyside, so this pipeline figure is authority-wide rather than specific to Bootle alone — planning applications aren't consistently attributable to a single town within a shared authority area.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `New-build properties in Bootle traded at a <strong>discount of 0.0%</strong> versus existing stock. Developers should focus on specification, design quality, and location to maximise values above comparable second-hand stock.`,
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£60,000</td><td>Flat</td><td>L30 2QY</td><td>2026-05-15</td><td>Existing</td></tr><tr><td>£170,000</td><td>Terraced</td><td>L30 5QX</td><td>2026-05-13</td><td>Existing</td></tr><tr><td>£116,000</td><td>Terraced</td><td>L30 3TG</td><td>2026-05-13</td><td>Existing</td></tr><tr><td>£163,500</td><td>Semi-detached</td><td>L20 7AP</td><td>2026-05-08</td><td>Existing</td></tr><tr><td>£125,000</td><td>Terraced</td><td>L30 2QB</td><td>2026-05-08</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £60,000 to £170,000 illustrates the breadth of the Bootle market.`,
      ],
    },
    {
