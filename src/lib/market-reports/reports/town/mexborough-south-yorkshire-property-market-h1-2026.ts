...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Mexborough`,
      content: [
        `City of Doncaster Council — the local planning authority covering Mexborough — has <strong>599</strong> residential units in its current pipeline, an estimated gross development value of <strong>£75.5m</strong>, across 139 applications (0 approved, 139 pending) at an approval rate of <strong>0%</strong>.`,
        `City of Doncaster Council covers more than one town in South Yorkshire, so this pipeline figure is authority-wide rather than specific to Mexborough alone — planning applications aren't consistently attributable to a single town within a shared authority area.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£200,000</td><td>Semi-detached</td><td>S64 9PB</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£155,000</td><td>Detached</td><td>S64 0HF</td><td>2026-05-15</td><td>Existing</td></tr><tr><td>£87,500</td><td>Terraced</td><td>S64 0LU</td><td>2026-05-06</td><td>Existing</td></tr><tr><td>£85,000</td><td>Terraced</td><td>S64 9QS</td><td>2026-05-05</td><td>Existing</td></tr><tr><td>£51,500</td><td>Terraced</td><td>S64 9NF</td><td>2026-05-05</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £51,500 to £200,000 illustrates the breadth of the Mexborough market.`,
      ],
    },
    {
