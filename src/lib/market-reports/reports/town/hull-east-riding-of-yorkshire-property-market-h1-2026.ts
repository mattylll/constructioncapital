...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Hull`,
      content: [
        `Hull City Council — the local planning authority covering Hull — has <strong>230</strong> residential units in its current pipeline, an estimated gross development value of <strong>£28.2m</strong>, across 28 applications (1 approved, 27 pending) at an approval rate of <strong>100%</strong>.`,
      ],
    },
    {
    ...
    {
      heading: `New Build Homes in Hull`,
      content: [
    ...
    {
      heading: `Recent Property Sales in Hull`,
      content: [
        `The following table shows the most recent property transactions recorded in Hull, providing real-time evidence of achieved prices for buyers, sellers, and developers:`,
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£50,000</td><td>Terraced</td><td>HU3 6AN</td><td>2026-05-27</td><td>Existing</td></tr><tr><td>£100,000</td><td>Terraced</td><td>HU5 1PT</td><td>2026-05-27</td><td>Existing</td></tr><tr><td>£65,000</td><td>Terraced</td><td>HU7 4HP</td><td>2026-05-27</td><td>Existing</td></tr><tr><td>£160,000</td><td>Semi-detached</td><td>HU6 7BA</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£105,000</td><td>Terraced</td><td>HU6 8PD</td><td>2026-05-20</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £50,000 to £160,000 illustrates the breadth of the Hull market.`,
      ],
    },
    {
      heading: `Development Finance in Hull`,
      content: [
        `For developers considering Hull, the local market data translates directly into finance structuring. With a median value of £130,000 and detached homes at £242,750, lenders can assess scheme viability with confidence.`,
        `A typical <a href="/services/development-finance">development finance</a> facility for a Hull scheme with a GDV of £242,750 would attract <strong>senior debt of approximately £157,788</strong> at 65% LTGDV. <a href="/services/mezzanine-finance">Mezzanine finance</a> can stretch total borrowing to 85-90% of costs, while <a href="/services/bridging-loans">bridging loans</a> enable rapid site acquisitions completing in as little as 5 working days.`,
        `While prices have remained flat year-on-year, experienced developers can still generate strong returns in Hull by targeting well-located sites with clear demand drivers.`,
        `Ready to develop in Hull? <a href="/deal-room">Submit your scheme</a> for indicative terms within 24 hours from our panel of 100+ lenders.`,
      ],
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Developers in Hull can access development finance from 6.5% p.a. at 65-70% LTGDV, mezzanine finance stretching to 85-90% of costs, bridging loans completing in 5-10 days, and development exit finance. Construction Capital sources the best terms from 100+ lenders.`,
    },
  ],
