...
const report: MarketReport = {
  ...
  metaTitle: "Stevenage House Prices 2026: £345,000 Median",
  metaDescription: "Stevenage house prices 2026: £345,000 median, 729 sales, +3% YoY. Sold-price trends by property type, new-build premiums and development finance.",
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Stevenage`,
      content: [
        `Stevenage Borough Council — the local planning authority covering Stevenage — has <strong>9</strong> residential units in its current pipeline, an estimated gross development value of <strong>£3.1m</strong>, across 1 applications (0 approved, 1 pending) at an approval rate of <strong>0%</strong>.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£285,000</td><td>Terraced</td><td>SG2 7QY</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£335,000</td><td>Terraced</td><td>SG2 7BN</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£350,000</td><td>Terraced</td><td>SG2 8JL</td><td>2026-05-21</td><td>Existing</td></tr><tr><td>£380,000</td><td>Detached</td><td>SG1 2BP</td><td>2026-05-20</td><td>Existing</td></tr><tr><td>£360,000</td><td>Terraced</td><td>SG1 4PG</td><td>2026-05-20</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £285,000 to £380,000 illustrates the breadth of the Stevenage market.`,
      ],
    },
    {
      heading: `Development Finance in Stevenage`,
      content: [
        `For developers considering Stevenage, the local market data translates directly into finance structuring. With a median value of £345,000 and detached homes at £558,500, lenders can assess scheme viability with confidence.`,
        `A typical <a href="/services/development-finance">development finance</a> facility for a Stevenage scheme with a GDV of £558,500 would attract <strong>senior debt of approximately £363,025</strong> at 65% LTGDV. <a href="/services/mezzanine-finance">Mezzanine finance</a> can stretch total borrowing to 85-90% of costs, while <a href="/services/bridging-loans">bridging loans</a> enable rapid site acquisitions completing in as little as 5 working days.`,
        `With prices rising 3% year-on-year, Stevenage presents a supportive environment for new development. Lenders view positive price momentum favourably when assessing loan applications.`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `House prices in Stevenage are rising at +3% year-on-year. This positive trend suggests sustained buyer demand. The wider Hertfordshire market is rising at +1.4%.`,
    },
    {
  ...
  charts: {"priceByType":[{"name":"Detached","value":558500},{"name":"Semi-detached","value":390000},{"name":"Terraced","value":335000},{"name":"Flat","value":197500}]},
};
