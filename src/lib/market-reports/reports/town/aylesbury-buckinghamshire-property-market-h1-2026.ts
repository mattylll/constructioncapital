...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Aylesbury`,
      content: [
        `Buckinghamshire Council — the local planning authority covering Aylesbury — has <strong>72</strong> residential units in its current pipeline, an estimated gross development value of <strong>£22.0m</strong>, across 6 applications (0 approved, 6 pending) at an approval rate of <strong>0%</strong>.`,
        `Buckinghamshire Council covers more than one town in Buckinghamshire, so this pipeline figure is authority-wide rather than specific to Aylesbury alone — planning applications aren't consistently attributable to a single town within a shared authority area.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£520,000</td><td>Semi-detached</td><td>HP17 8DZ</td><td>2026-05-26</td><td>Existing</td></tr><tr><td>£415,000</td><td>Semi-detached</td><td>HP22 5WU</td><td>2026-05-21</td><td>Existing</td></tr><tr><td>£295,000</td><td>Flat</td><td>HP22 6AX</td><td>2026-05-20</td><td>Existing</td></tr><tr><td>£660,000</td><td>Semi-detached</td><td>HP22 4PT</td><td>2026-05-20</td><td>Existing</td></tr><tr><td>£245,000</td><td>Terraced</td><td>HP21 8LT</td><td>2026-05-18</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £245,000 to £660,000 illustrates the breadth of the Aylesbury market.`,
      ],
    },
    {
