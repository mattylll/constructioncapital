...
const report: MarketReport = {
  ...
  metaTitle: "Driffield House Prices 2026: £215,000 Median",
  metaDescription: "Driffield house prices 2026: £215,000 median, 501 sales, 0% YoY. Sold-price trends by property type, new-build premiums and development finance.",
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Driffield`,
      content: [
        `East Riding of Yorkshire Council — the local planning authority covering Driffield — has <strong>0</strong> residential units in its current pipeline, an estimated gross development value of <strong>£0</strong>, across 0 applications (0 approved, 0 pending) at an approval rate of <strong>0%</strong>.`,
        `East Riding of Yorkshire Council covers more than one town in East Riding of Yorkshire, so this pipeline figure is authority-wide rather than specific to Driffield alone — planning applications aren't consistently attributable to a single town within a shared authority area.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£178,000</td><td>Semi-detached</td><td>YO25 6SL</td><td>2026-05-21</td><td>Existing</td></tr><tr><td>£235,000</td><td>Semi-detached</td><td>YO25 4PF</td><td>2026-05-15</td><td>Existing</td></tr><tr><td>£335,000</td><td>Detached</td><td>YO25 9HP</td><td>2026-05-15</td><td>Existing</td></tr><tr><td>£375,000</td><td>Detached</td><td>YO25 6RP</td><td>2026-05-15</td><td>Existing</td></tr><tr><td>£285,000</td><td>Detached</td><td>YO25 5BZ</td><td>2026-05-14</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £178,000 to £375,000 illustrates the breadth of the Driffield market.`,
      ],
    },
    {
      heading: `Development Finance in Driffield`,
      content: [
        `For developers considering Driffield, the local market data translates directly into finance structuring. With a median value of £215,000 and detached homes at £305,000, lenders can assess scheme viability with confidence.`,
        ...
        `While prices have remained flat year-on-year, experienced developers can still generate strong returns in Driffield by targeting well-located sites with clear demand drivers.`,
