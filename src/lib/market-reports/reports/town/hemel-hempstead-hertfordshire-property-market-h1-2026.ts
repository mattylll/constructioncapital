...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Hemel Hempstead`,
      content: [
        `Dacorum Borough Council — the local planning authority covering Hemel Hempstead — has <strong>673</strong> residential units in its current pipeline, an estimated gross development value of <strong>£304.0m</strong>, across 127 applications (26 approved, 101 pending) at an approval rate of <strong>100%</strong>.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£770,000</td><td>Detached</td><td>HP23 5JL</td><td>2026-05-28</td><td>Existing</td></tr><tr><td>£270,000</td><td>Terraced</td><td>HP1 2TD</td><td>2026-05-26</td><td>Existing</td></tr><tr><td>£154,000</td><td>Flat</td><td>HP23 5EW</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£170,000</td><td>Flat</td><td>HP2 6DH</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£775,000</td><td>Detached</td><td>HP4 1LW</td><td>2026-05-21</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £154,000 to £775,000 illustrates the breadth of the Hemel Hempstead market.`,
      ],
    },
    {
      heading: `Development Finance in Hemel Hempstead`,
      content: [
        `For developers considering Hemel Hempstead, the local market data translates directly into finance structuring. With a median value of £450,000 and detached homes at £790,000, lenders can assess scheme viability with confidence.`,
        ...
        `With prices rising 2.3% year-on-year, Hemel Hempstead presents a supportive environment for new development. Lenders view positive price momentum favourably when assessing loan applications.`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `House prices in Hemel Hempstead are rising at +2.3% year-on-year. This positive trend suggests sustained buyer demand. The wider Hertfordshire market is rising at +1.4%.`,
    },
    {
  ...
  charts: {"priceByType":[{"name":"Detached","value":790000},{"name":"Semi-detached","value":534000},{"name":"Terraced","value":416500},{"name":"Flat","value":252000}]},
};
