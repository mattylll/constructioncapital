...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in York`,
      content: [
        `City of York Council — the local planning authority covering York — has <strong>15</strong> residential units in its current pipeline, an estimated gross development value of <strong>£4.0m</strong>, across 231 applications (0 approved, 231 pending) at an approval rate of <strong>0%</strong>.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£335,000</td><td>Semi-detached</td><td>YO24 4EU</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£295,000</td><td>Terraced</td><td>YO30 7EH</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£362,500</td><td>Detached</td><td>YO32 5AX</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£210,000</td><td>Flat</td><td>YO31 7EG</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£340,000</td><td>Semi-detached</td><td>YO26 5NU</td><td>2026-05-22</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £210,000 to £362,500 illustrates the breadth of the York market.`,
      ],
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `House prices in York are flat at 0% year-on-year. The market is broadly stable. The wider North Yorkshire market is falling at -2.1%.`,
    },
    {
