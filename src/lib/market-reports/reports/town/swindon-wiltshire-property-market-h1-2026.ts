...
const report: MarketReport = {
  ...
  metaDescription: "Swindon house prices 2026: £270,000 median, 2,627 sales, -2.5% YoY. Sold-price trends by property type, new-build premiums and development finance.",
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£185,000</td><td>Terraced</td><td>SN2 7TZ</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£355,000</td><td>Semi-detached</td><td>SN2 7AE</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£229,400</td><td>Terraced</td><td>SN3 5BL</td><td>2026-05-21</td><td>Existing</td></tr><tr><td>£150,000</td><td>Semi-detached</td><td>SN2 2NS</td><td>2026-05-21</td><td>Existing</td></tr><tr><td>£495,000</td><td>Detached</td><td>SN5 5UG</td><td>2026-05-19</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £150,000 to £495,000 illustrates the breadth of the Swindon market.`,
      ],
    },
    {
      heading: `Development Finance in Swindon`,
      content: [
        `For developers considering Swindon, the local market data translates directly into finance structuring. With a median value of £270,000 and detached homes at £415,000, lenders can assess scheme viability with confidence.`,
        ...
        `While prices have softened 2.5% year-on-year, experienced developers can still generate strong returns in Swindon by targeting well-located sites with clear demand drivers.`,
