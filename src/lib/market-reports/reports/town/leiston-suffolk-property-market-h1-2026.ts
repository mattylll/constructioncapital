...
const report: MarketReport = {
  slug: "leiston-suffolk-property-market-h1-2026",
  title: "Leiston Property Market: House Prices, Sold Data & Development Finance, End of H1 2026",
  metaTitle: "Leiston House Prices, End of H1 2026: £257,000 Median",
  metaDescription: "Leiston house prices as at the end of H1 2026: £257,000 median, 91 sales, +9.8% YoY. Sold-price trends by property type, planning pipeline, new-build premiums and development finance.",
  excerpt: "Median price £257,000, 91 sales, +9.8% YoY. Suffolk county.",
  category: "town",
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Leiston`,
      content: [
        `East Suffolk Council — the local planning authority covering Leiston — has <strong>1,073</strong> residential units in its current pipeline, an estimated gross development value of <strong>£274.5m</strong>, across 242 applications (63 approved, 179 pending) at an approval rate of <strong>94%</strong>.`,
        `East Suffolk Council covers more than one town in Suffolk, so this pipeline figure is authority-wide rather than specific to Leiston alone — planning applications aren't consistently attributable to a single town within a shared authority area.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        `For developers considering Leiston, the local market data translates directly into finance structuring. With a median value of £257,000 and detached homes at £417,500, lenders can assess scheme viability with confidence.`,
        ...
        `With prices rising 9.8% year-on-year, Leiston presents a supportive environment for new development. Lenders view positive price momentum favourably when assessing loan applications.`,
  ...
  faqs: [
    {
      ...
      answer: `The median house price in Leiston is £257,000, based on 91 transactions over the past 12 months. Detached homes average £417,500 while flat properties average £116,250.`,
    },
    {
    ...
    },
    {
      ...
      answer: `Leiston recorded 91 residential property sales in the past 12 months. This is a smaller market where properties may take longer to sell.`,
    },
    {
  ...
  relatedReportSlugs: ["suffolk-property-market-h1-2026", "east-of-england-market-overview-h1-2026", "bury-st-edmunds-suffolk-property-market-h1-2026", "felixstowe-suffolk-property-market-h1-2026", "ipswich-suffolk-property-market-h1-2026", "lowestoft-suffolk-property-market-h1-2026"],
  relatedTownSlugs: ["suffolk/leiston"],
  relatedServiceSlugs: ["development-finance", "bridging-loans", "mezzanine-finance"],
  charts: {"priceByType":[{"name":"Detached","value":417500},{"name":"Semi-detached","value":240500},{"name":"Terraced","value":200000},{"name":"Flat","value":116250}]},
};
