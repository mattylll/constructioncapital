...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Luton`,
      content: [
        `Luton Borough Council — the local planning authority covering Luton — has <strong>478</strong> residential units in its current pipeline, an estimated gross development value of <strong>£83.7m</strong>, across 39 applications (0 approved, 39 pending) at an approval rate of <strong>0%</strong>.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£315,000</td><td>Semi-detached</td><td>LU2 8RA</td><td>2026-05-28</td><td>Existing</td></tr><tr><td>£150,000</td><td>Semi-detached</td><td>LU4 9FS</td><td>2026-05-26</td><td>Existing</td></tr><tr><td>£330,000</td><td>Semi-detached</td><td>LU4 9ER</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£230,000</td><td>Semi-detached</td><td>LU1 3SN</td><td>2026-05-21</td><td>Existing</td></tr><tr><td>£272,500</td><td>Terraced</td><td>LU2 7JH</td><td>2026-05-20</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £150,000 to £330,000 illustrates the breadth of the Luton market.`,
      ],
    },
    {
      heading: `Development Finance in Luton`,
      content: [
        `For developers considering Luton, the local market data translates directly into finance structuring. With a median value of £300,000 and detached homes at £430,000, lenders can assess scheme viability with confidence.`,
