...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Recent Property Sales in Peterborough`,
      content: [
        `The following table shows the most recent property transactions recorded in Peterborough, providing real-time evidence of achieved prices for buyers, sellers, and developers:`,
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£163,000</td><td>Terraced</td><td>PE2 5TP</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£165,000</td><td>Terraced</td><td>PE2 5RP</td><td>2026-05-22</td><td>Existing</td></tr><tr><td>£299,000</td><td>Semi-detached</td><td>PE2 6HA</td><td>2026-05-21</td><td>Existing</td></tr><tr><td>£156,000</td><td>Terraced</td><td>PE8 6EN</td><td>2026-05-20</td><td>Existing</td></tr><tr><td>£365,130</td><td>Semi-detached</td><td>PE3 6FB</td><td>2026-05-19</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £156,000 to £365,130 illustrates the breadth of the Peterborough market.`,
      ],
    },
    {
      heading: `Development Finance in Peterborough`,
      content: [
        `For developers considering Peterborough, the local market data translates directly into finance structuring. With a median value of £235,000 and detached homes at £330,000, lenders can assess scheme viability with confidence.`,
        `A typical <a href="/services/development-finance">development finance</a> facility for a Peterborough scheme with a GDV of £330,000 would attract <strong>senior debt of approximately £214,500</strong> at 65% LTGDV. <a href="/services/mezzanine-finance">Mezzanine finance</a> can stretch total borrowing to 85-90% of costs, while <a href="/services/bridging-loans">bridging loans</a> enable rapid site acquisitions completing in as little as 5 working days.`,
        `While prices have softened 2.1% year-on-year, experienced developers can still generate strong returns in Peterborough by targeting well-located sites with clear demand drivers.`,
        `Ready to develop in Peterborough? <a href="/deal-room">Submit your scheme</a> for indicative terms within 24 hours from our panel of 100+ lenders.`,
      ],
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Developers in Peterborough can access development finance from 6.5% p.a. at 65-70% LTGDV, mezzanine finance stretching to 85-90% of costs, bridging loans completing in 5-10 days, and development exit finance. Construction Capital sources the best terms from 100+ lenders.`,
    },
  ],
  ...
  relatedTownSlugs: ["cambridgeshire/peterborough"],
  relatedServiceSlugs: ["development-finance", "bridging-loans", "mezzanine-finance"],
  charts: {"priceByType":[{"name":"Detached","value":330000},{"name":"Semi-detached","value":240000},{"name":"Terraced","value":185000},{"name":"Flat","value":120000}]},
};
