...
const report: MarketReport = {
  ...
  sections: [
    ...
    {
      heading: `Planning Pipeline in Hay-on-Wye`,
      content: [
        `Powys County Council — the local planning authority covering Hay-on-Wye — has <strong>0</strong> residential units in its current pipeline, an estimated gross development value of <strong>£0</strong>, across 4 applications (4 approved, 0 pending) at an approval rate of <strong>100%</strong>.`,
        `Powys County Council covers more than one town in Powys, so this pipeline figure is authority-wide rather than specific to Hay-on-Wye alone — planning applications aren't consistently attributable to a single town within a shared authority area.`,
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `<table><thead><tr><th>Price</th><th>Type</th><th>Postcode</th><th>Date</th><th>Status</th></tr></thead><tbody><tr><td>£187,500</td><td>Semi-detached</td><td>LD3 9BL</td><td>2026-05-28</td><td>Existing</td></tr><tr><td>£253,000</td><td>Semi-detached</td><td>LD3 9BS</td><td>2026-05-18</td><td>Existing</td></tr><tr><td>£200,000</td><td>Terraced</td><td>LD3 8DN</td><td>2026-05-18</td><td>Existing</td></tr><tr><td>£150,000</td><td>Terraced</td><td>SY21 0NR</td><td>2026-05-18</td><td>Existing</td></tr><tr><td>£299,000</td><td>Terraced</td><td>LD3 7EN</td><td>2026-05-15</td><td>Existing</td></tr></tbody></table>`,
        `These transactions are sourced from HM Land Registry Price Paid data and represent completed, registered sales. The range from £150,000 to £299,000 illustrates the breadth of the Hay-on-Wye market.`,
      ],
    },
    {
      heading: `Development Finance in Hay-on-Wye`,
      content: [
        `For developers considering Hay-on-Wye, the local market data translates directly into finance structuring. With a median value of £250,000 and detached homes at £340,000, lenders can assess scheme viability with confidence.`,
