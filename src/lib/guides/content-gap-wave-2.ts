...
const WAVE_2_RAW: Omit<Guide, "readingTime">[] = [
  {
    ...
    metaDescription:
      "How SDLT applies to UK property developers: residential vs commercial rates, the 5% surcharge, mixed-use rules, the 17% corporate rate, and the reliefs that still matter after MDR was abolished in June 2024.",
    excerpt:
    ...
    sections: [
      {
        ...
        content: [
          ...
          '<div class="my-4 rounded-lg border-l-4 border-gold bg-gold/5 p-4"><p class="text-sm font-semibold text-gold-dark mb-1">Expert Insight</p><p class="text-sm">SDLT is the cost line that catches first-time developers out most often. The difference between commercial and residential rates with the 5% surcharge on a &pound;1.5M site can exceed &pound;100,000 &mdash; enough to move a marginal project from viable to unviable. We always recommend running the SDLT analysis before exchanging contracts, not after.</p></div>',
        ],
      },
      {
        heading: "Residential vs commercial SDLT rates",
        content: [
          "The single biggest driver of SDLT cost on a development site is the residential or non-residential classification. Residential rates are higher than commercial rates at every tier above £250,000, and where a residential property is acquired by a company or SPV the residential rates also attract a 5% surcharge across every band. The classification turns on the use or planned use at the date of completion, not the eventual use after the development is built out.",
          ...
          "The 2026 SDLT rates for England and Northern Ireland are set out below. The table shows the standard residential rates that apply to a single dwelling bought by an individual as their main residence, the higher residential rates (including the 5% surcharge) that apply to most company and SPV purchases, and the commercial rates that apply to non-residential and mixed-use purchases regardless of buyer type:",
          '<table class="w-full text-sm border-collapse my-6"><thead><tr><th class="text-left py-2 px-3 bg-muted/50 font-semibold border-b">Band</th><th class="text-left py-2 px-3 bg-muted/50 font-semibold border-b">Residential rate</th><th class="text-left py-2 px-3 bg-muted/50 font-semibold border-b">Residential higher rate (company / SPV)</th><th class="text-left py-2 px-3 bg-muted/50 font-semibold border-b">Non-residential / mixed-use rate</th></tr></thead><tbody><tr><td class="py-2 px-3 border-b">Up to &pound;125,000</td><td class="py-2 px-3 border-b">0%</td><td class="py-2 px-3 border-b">5%</td><td class="py-2 px-3 border-b">0%</td></tr><tr><td class="py-2 px-3 border-b">&pound;125,001 &ndash; &pound;150,000</td><td class="py-2 px-3 border-b">2%</td><td class="py-2 px-3 border-b">7%</td><td class="py-2 px-3 border-b">0%</td></tr><tr><td class="py-2 px-3 border-b">&pound;150,001 &ndash; &pound;250,000</td><td class="py-2 px-3 border-b">2%</td><td class="py-2 px-3 border-b">7%</td><td class="py-2 px-3 border-b">2%</td></tr><tr><td class="py-2 px-3 border-b">&pound;250,001 &ndash; &pound;925,000</td><td class="py-2 px-3 border-b">5%</td><td class="py-2 px-3 border-b">10%</td><td class="py-2 px-3 border-b">5%</td></tr><tr><td class="py-2 px-3 border-b">&pound;925,001 &ndash; &pound;1.5M</td><td class="py-2 px-3 border-b">10%</td><td class="py-2 px-3 border-b">15%</td><td class="py-2 px-3 border-b">5%</td></tr><tr><td class="py-2 px-3 border-b">Above &pound;1.5M</td><td class="py-2 px-3 border-b">12%</td><td class="py-2 px-3 border-b">17%</td><td class="py-2 px-3 border-b">5%</td></tr></tbody></table>',
          "These thresholds are set at fiscal events and can move. The residential bands above have applied since 1 April 2025, when the temporary £250,000 nil-rate band ended, and the 5% higher-rates surcharge has applied since 31 October 2024. We confirm the live rates with HMRC's guidance at the point of exchange on every transaction we fund.",
        ],
      },
      {
        heading: "Worked example: SDLT on a £1.5M acquisition",
        content: [
          "Let us work through a practical SDLT calculation for a typical small-developer scheme. Assume a developer trading through an SPV is acquiring a site for £1,500,000 with planning permission for six houses in Hampshire. The vendor lives on the site in an existing dwelling that the developer will demolish. The site is therefore residential at the date of completion, the buyer is a company, and the 5% higher-rates surcharge applies across every band.",
          "Calculating SDLT band by band: the first £125,000 is taxed at 5% (the 0% band plus the 5% surcharge), giving £6,250. The next £125,000 (from £125,001 to £250,000) is taxed at 7% (2% standard plus 5% surcharge), giving £8,750. The next £675,000 (from £250,001 to £925,000) is taxed at 10% (5% standard plus 5% surcharge), giving £67,500. The remaining £575,000 (from £925,001 to £1,500,000) is taxed at 15% (10% standard plus 5% surcharge), giving £86,250. Total SDLT on the £1.5M acquisition is £168,750, which is 11.25% of the purchase price.",
          "Now consider the alternative scenario where the site is genuinely mixed-use at completion — for example, if there is an active tenanted commercial unit on the site, or active commercial use in part of the garden — and the entire purchase qualifies for commercial rates. The first £150,000 is at 0%, the next £100,000 is at 2% (£2,000), and the remaining £1,250,000 is at 5% (£62,500). Total commercial-rate SDLT is £64,500, which is 4.3% of the purchase price. The mixed-use classification saves the developer £104,250 on this single transaction.",
          "We have seen developers re-negotiate purchase prices off the back of the SDLT analysis alone, particularly where the vendor was unaware of the mixed-use treatment. The saving of roughly £54,000 to £164,000 on a typical £1M–£2M acquisition is meaningful and is one of the reasons we always recommend running the SDLT model before bidding on a site, not after.",
        ],
      },
      {
        heading: "The 5% surcharge and how it lands on developer SPVs",
        content: [
          "Where a residential property is acquired by a company, a partnership, or by an individual who already owns another residential property, an additional 5% surcharge applies on top of every standard residential SDLT band. The surcharge rose from 3% to 5% for transactions with an effective date on or after 31 October 2024. It is not a separate band — it is layered across every rate, meaning the effective rate ranges from 5% on the lowest band up to 17% at the top.",
          ...
          'For purchases by non-UK resident buyers there is a further 2% surcharge layered on top of the 5% higher-rates surcharge, taking the maximum effective banded rate on residential property to 19%. The non-resident surcharge applies to companies as well as individuals and has its own definition of residency — overseas-controlled SPVs should plan for it in their appraisal. See our <a href="/guides/foreign-national-development-finance-uk">foreign national development finance</a> guide for the funding implications.',
        ],
      },
      {
      ...
      {
        heading: "The 17% corporate rate on high-value residential",
        content: [
          "A flat 17% SDLT rate applies to residential property worth more than £500,000 acquired by 'non-natural persons' — companies, partnerships including a company member, and collective investment schemes. The rate, set by Schedule 4A of the Finance Act 2003, rose from 15% to 17% for transactions with an effective date on or after 31 October 2024. It was introduced alongside the Annual Tax on Enveloped Dwellings (ATED) regime to discourage the use of corporate envelopes to hold high-value London residential property, but it can catch developers off-guard on otherwise standard SPV acquisitions.",
          "Critical for developers: a relief from the 17% rate is available where the property is acquired by a property development company for the bona fide purpose of resale in the course of a property development trade, and where the company has been carrying on that trade for at least two years. The relief is also available for property rental businesses, property trading companies, and a small number of other qualifying activities. It is claimed in the SDLT return, with supporting evidence usually provided to the buyer's solicitor before submission.",
          "Even where the relief applies and the 17% rate is avoided, the standard residential rates with the 5% higher-rates surcharge will apply instead. A relief claim does not move the purchase to commercial rates — it moves it from the 17% punitive rate down to the standard residential plus 5% rates. On a £1.5M property, that is the difference between £255,000 and £168,750, a saving of £86,250.",
          "The 17% rate has anti-avoidance teeth. If the property is sold within three years of acquisition for a purpose that does not qualify for the original relief, HMRC can claw back the relief and charge the 17% rate retrospectively with interest. We always recommend that developers using corporate envelopes document the development activity throughout the project — site progress photographs, planning correspondence, contractor records — to support the original relief claim if it is ever challenged.",
        ],
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. Property developers pay SDLT on the acquisition of development sites in England and Northern Ireland, on the same rates and bands as other buyers but with the 5% higher-rates surcharge applied to residential property acquired by a company or SPV. The equivalent taxes in Scotland (LBTT) and Wales (LTT) operate on similar principles with different rates and thresholds. SDLT is charged on the buyer rather than the seller and is paid at completion.",
      },
      {
        question: "Is there a stamp duty relief for property developers?",
        answer:
          "Yes, but the reliefs are narrower than they were before June 2024 when Multiple Dwellings Relief was abolished. The non-residential treatment of bulk residential purchases of six or more dwellings is still available, as is the relief from the 17% corporate rate for genuine property development companies that have been trading for at least two years. House-builder relief for accepting a part-exchange property remains in force. Specific tax advice should always be obtained.",
      },
      {
